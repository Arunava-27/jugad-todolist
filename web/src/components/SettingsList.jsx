...
// a "reassign in-use items first" fallback, and adding a new row.
export default function SettingsList({ items, onCreate, onUpdate, onDelete, renderRowExtra, addPlaceholder = 'Add new…' }) {
